/*
 *
 * * Copyright 1999-2018 Alibaba Group Holding Ltd. * * Licensed under the Apache License, Version
...
public class ModuleRuntimeException extends RuntimeException {
    ...
    public ModuleRuntimeException(Module module, String message) {
        super(module.getName() + "-" + module.getVersion() + ",message:" + message);
    }

    public ModuleRuntimeException(Module module, String message, Throwable cause) {
        super(module.getName() + "-" + module.getVersion() + ",message:" + message, cause);
    }
