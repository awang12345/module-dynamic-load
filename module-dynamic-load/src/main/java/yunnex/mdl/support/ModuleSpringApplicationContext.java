 ...
 * @date 2018年3月29日
 */
public class ModuleSpringApplicationContext extends ClassPathXmlApplicationContext {

    private static final Logger LOGGER = LoggerFactory.getLogger(ModuleSpringApplicationContext.class);
    ...
    public ModuleSpringApplicationContext(ApplicationContext parent) {
        super(parent);
    }
